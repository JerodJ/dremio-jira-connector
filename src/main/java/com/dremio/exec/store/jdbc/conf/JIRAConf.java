...
@SourceType(value = "JIRAARP", label = "JIRA",uiConfig = "jira-layout.json")
public class JIRAConf extends AbstractArpConf<JIRAConf> {
  private static final String ARP_FILENAME = "arp/implementation/jira-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.jira.JIRADriver";
